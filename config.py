...
MONGO_DB_URL = getenv("MONGO_DB_URL", "mongodb+srv://loly:<password>@lolychan.d4msctp.mongodb.net/?retryWrites=true&w=majority&appName=AtlasApp")
OWNER_NAME = getenv("OWNER_NAME", "Neko")
OWNER_USERNAME = getenv("OWNER_USERNAME", "OwnNeko")
ALIVE_NAME = getenv("ALIVE_NAME", "LolyMusic")
BOT_USERNAME = getenv("BOT_USERNAME", "LolyChanMusicBot")
OWNER_ID = getenv("OWNER_ID", "5633222043")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "LolyChanAssistant")
